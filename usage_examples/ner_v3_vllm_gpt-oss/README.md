...
This example shows how you can use a model from OpenAI hosted on VLLM for Named Entity Recognition (NER).
...
This is unnecessary because we access a local API, but if not done would give a warning.
```sh
